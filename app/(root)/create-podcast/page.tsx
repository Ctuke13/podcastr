        ...
        >
          <div className="flex flex-col gap-[30px border-b border-black-5 pb-10">
            <FormField
              ...
              name="podcastTitle"
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5 mb-6">
            ...
            <div className=" flex flex-col gap-2.5">
              ...
              <Select onValueChange={(value) => setVoiceType(value as VoiceType)}>
                <SelectTrigger
                  className={cn(
                    "text-16 w-full border-none bg-black-1 text-gray-1 focus-visible:ring-offset-orange-1  mb-6 "
                  )}
                >
                  <SelectValue
                ...
                <SelectContent className="text-16 border-none bg-black-1 font-bold text-white-1 focus-visible:ring-offset-orange-1">
                  {voiceCategories.map((category) => (
                    <SelectItem
                      className="capitalize focus-visible:ring-offset-orange-1"
                      key={category}
                      value={category}
                    >
                      {category}
